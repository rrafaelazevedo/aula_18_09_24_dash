...
fig = px.bar(df, x='Hora Fim (x)', y='Número Médio Ligantes f(x)', color='Momento', barmode='group') 
...
def update_output(value):
    if value == 'Todos os Momentos':
        ...
        fig = px.bar(tabela_filtrada, x='Hora Fim - (x)', y='Número Médio Ligantes - f(x)', color='Momento', barmode='group')
